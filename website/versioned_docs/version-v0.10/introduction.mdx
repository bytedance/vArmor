...
For an AppArmor-specific worked example, see [the existing usage example](getting_started/usage_instructions.md#example) and adapt it only after checking AppArmor support. `AlwaysAllow` establishes a profile without adding restrictions; use a restrictive mode to block operations.
...
For more demos, please check out our GitHub repository [here](https://github.com/bytedance/vArmor/tree/v0.10.5/test/demos).
