      ...
      <div className="container">
        ...
        <div className="row">
          ...
          <Feature
            ...
            description={<Translate id="homepage.features.networkProxy.description">Transparently intercepts container egress via an Envoy sidecar, enabling L4/L7 access control, HTTPS header injection, audit logging, and dynamic policy updates without Pod restarts.</Translate>}
          ...
          <Feature
            ...
            description={<Translate id="homepage.features.aiAgent.description">Defense-in-depth for AI Agents — enforcing access control from syscalls to network protocols, effectively mitigating risks of prompt injection-induced tool abuse, key leakage, and data exfiltration.</Translate>}
      ...
      <div className="container">
        ...
        <div className={styles.quickStartSteps}>
          ...
          <div className={styles.quickStartStep}>
            ...
            <CodeBlock language="bash">
              helm install varmor varmor-0.10.5.tgz --namespace varmor --create-namespace --set image.registry="elkeid-ap-southeast-1.cr.volces.com"
            </CodeBlock>
          </div>
          <div className={styles.quickStartStep}>
