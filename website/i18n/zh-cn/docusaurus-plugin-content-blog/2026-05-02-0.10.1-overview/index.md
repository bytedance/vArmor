...
为了进一步简化这一工作流，vArmor v0.10.1 还内置了 **[`copy-fail-mitigation`](http://localhost:3000/zh-cn/docs/v0.10/guides/policies_and_rules/built_in_rules/vulnerability_mitigation#copy-fail-mitigation)** 规则，用户可以通过一个规则名称直接启用相同的防护——无需手动编写策略：
