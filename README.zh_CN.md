...
*<br />- vArmor 的 NetworkProxy enforcer 进一步补充了 NetworkPolicy 的不足，提供了 HTTP/HTTPS 的 L7 访问控制（基于 TLS MITM）、基于 TLS SNI 的域名过滤、逐域名 HTTP 请求头注入、防域前置攻击以及全面的审计日志能力——这些是 NetworkPolicy 所不具备的。*
