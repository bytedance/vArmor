...
|      ||bpfRawRules<br />*[BpfRawRules](#bpfrawrules)*|Optional. BpfRawRules is used to set custom BPF rules.
...
|network<br />*NetworkRule*     |egresses<br />*[NetworkEgressRule](#networkegressrule) array*|Optional. Egresses are the list of egress rules to be applied to restrict particular IPs and ports.
