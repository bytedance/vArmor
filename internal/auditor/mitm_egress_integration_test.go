...
func TestMITMEgressEnvoyAudit(t *testing.T) {
	...
	// Direct IPv6 authorities currently hit an independent virtual-host
	// formatting limitation ([::1] versus ::1). Exercise IPv6 destinations
	// through DNS/SNI here without changing the generated virtual hosts.
