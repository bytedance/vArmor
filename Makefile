...
VARMOR_IMAGE_TAG_DEV := $(shell VERSION=$(GIT_VERSION); echo $${VERSION%-*})
VARMOR_IMAGE_DEV ?= $(REPO_DEV)/$(VARMOR_IMAGE_NAME):$(VARMOR_IMAGE_TAG_DEV)
CLASSIFIER_IMAGE_TAG_DEV := $(shell VERSION=$(GIT_VERSION); echo $${VERSION%-*})
CLASSIFIER_IMAGE_DEV ?= $(REPO_DEV)/$(CLASSIFIER_IMAGE_NAME):$(CLASSIFIER_IMAGE_TAG_DEV)
CHART_APP_VERSION_DEV := $(shell VERSION=$(GIT_VERSION); echo $${VERSION%-*})
