...
var armorprofilemodelsResource = v1beta1.SchemeGroupVersion.WithResource("armorprofilemodels")

var armorprofilemodelsKind = v1beta1.SchemeGroupVersion.WithKind("ArmorProfileModel")
